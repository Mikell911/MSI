            ...
            <div className={"container"}>
                <section>
                    ...
                    >
                        ...
                        <SwiperSlide><Link to={'/'}><img src={Img} alt="Slider Image" /></Link></SwiperSlide>
                        {/* eslint-disable-next-line jsx-a11y/img-redundant-alt */}
                        <SwiperSlide><Link to={'/'}><img src={Img} alt="Slider Image" /></Link></SwiperSlide>
                    </Swiper>
                </section>

                <section className={"pt-9 max-lg:pt-4"}>
                    <h2 className={'text-xl font-semibold max-md:text-base'}>
                        New Products
                    </h2>
                ...
                <section className={"pt-5 max-sm:pt-1"}>
                    <div className={"container bg-light-grey py-6 flex gap-6 items-center justify-center max-md:py-2"}>
                        ...
                        <p className={"text-lg font-normal text-dark-blue max-md:text-sl"}>
                            <span className={"font-semibold"}>own</span> it now, up to 6 months interest free
                            <Link to={'/'} className={"text-sm underline ml-1 max-md:text-sl"}>
                                learn more
                            </Link>
                        </p>
                ...
                <BannerFirm className={'pt-7 max-sm:pt-1'} banners={BannerFirms} classNameImg={'max-w-32 max-lg:max-w-20 max-sm:max-w-16'}/>

                <Post title={'Follow us on Instagram for News, Offers & More'} className={'pt-11'} posts={Posts}/>

                <Review reviews={Reviews} button={'Leave Us A Review'} className={'pt-14'}/>
            </div>
        </main>
    )
}
